...
router.get('/projects/:projectId/tasks/:limit?/:page?', activityController.findTaskResponse)//all tasks of a project
...
router.get('/teams/:memberId',activityController.findTeamResponse);//get all teams of a member
router.get('/teams/:teamId/projects', activityController.findTeamProjectsResponse);//projects of a team 
router.get('/teams/:teamId/members',activityController.findTeamMembersResponse);//members of a team
